...
class Interpretor:
	...
	def wasmEvalNumber(self, ast):
		# open("log.log", "a").write("S-a atins evalNumber\n")
	...
	def wasmEvalIfHelper(ast):
		# open("log.log", "a").write("S-a atins EvalIfHelper\n")
	...
	def wasmEvalIf(self, ast):
		# open("log.log", "a").write("S-a atins EvalIf\n")
	...
	def wasmEvalKeyword(self, ast):
		# open("log.log", "a").write("S-a atins EvalKeyword\n")
