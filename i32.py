...
class i32:
    ...
    def popcnt(t1, t2):
        ...
        while base<=(1<<31):
            ...
            base = base << 1
    def extend8_s(t1):
        ans = i32(int.from_bytes(t1._val.to_bytes(1, 'little', signed=True), 'little', signed=True))
        return ans
    def extend16_s(t1):
        ans = i32(int.from_bytes(t1._val.to_bytes(2, 'little', signed=True), 'little', signed=True))
        return ans
    def eqz(t1):
